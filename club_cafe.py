...
#     What started as a small family kitchen filled with the smell of grandma’s signature cheesecake has grown into the café you see today.
# 
...
#     st.title("📍 Location & Timings")
#     st.markdown("""
#     **📍 Address:** Club Cafe, MG Road, Pune, Maharashtra, India
# 
...
#     st.info("⭐⭐⭐⭐⭐ Best cakes in town! – Rahul")
#     st.info("⭐⭐⭐⭐ Loved the Red Velvet cake – Anjali")
#     st.info("⭐⭐⭐⭐⭐ Amazing ambience and taste – Sneha")
#     st.info("⭐⭐⭐⭐⭐ One of the best pastry and cake franchises. The costs are on the higher side but definitely worth the experience. So far, I've tried the Hazelnut chocolate pastry, dutch truffle pastry - Akhil")
# 
# # CONTACT US (DATABASE LINKED)
# elif page == "Contact Us":
#     st.title("📞 Contact Us")
#     st.markdown("**📧 Email:** clubcafe@gmail.com | **📱 Phone:** +91 98765 43210")
# 
...
#                 st.success("📩 Message sent successfully and saved to database!")
#             else:
